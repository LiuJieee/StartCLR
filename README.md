...
```
* The training and test datasets of StartCLR are available in the file all_dataset_xxx.zip, which can be downloaded from https://zenodo.org/records/15117521. Additionally, the pre-trained encoder and fine-tuned model are also available for download at the same link.
